...
public class EasyActivity extends AppCompatActivity {
    ...
    //初始化空白区域的按钮id
    private int blankImageid = R.id.pt_line2_02x02;

    //存储图片的数组
    private int[]image = {R.mipmap.es_00x00,R.mipmap.es_00x01,R.mipmap.es_00x02,
            R.mipmap.es_01x00,R.mipmap.es_01x01,R.mipmap.es_01x02,
            R.mipmap.es_02x00,R.mipmap.es_02x01,R.mipmap.es_02x02,};
...
//        随机排列到指定的控件上
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.pt_line1_01x00:
                move(R.id.pt_line1_01x00,3);
                break;
            case R.id.pt_line1_01x01:
                move(R.id.pt_line1_01x01,4);
                break;
            case R.id.pt_line1_01x02:
                move(R.id.pt_line1_01x02,5);
                break;
            case R.id.pt_line2_02x00:
                move(R.id.pt_line2_02x00,6);
                break;
            case R.id.pt_line2_02x01:
                move(R.id.pt_line2_02x01,7);
                break;
            case R.id.pt_line2_02x02:
                move(R.id.pt_line2_02x02,8);
                break;
        }
    }
    ...
    private void restore() {
        ...
        //隐藏第8张图片
        ImageButton blankBtn = findViewById(R.id.pt_line2_02x02);
        blankBtn.setVisibility(View.INVISIBLE);

        //将第八张图片设置成空白
        blankImageid = R.id.pt_line2_02x02;
